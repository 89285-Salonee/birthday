      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Vaibhav</span> ❤️
              </>
            ) : (
              <>
                Counting down to <span className="highlight">Vaibhav's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>
I hope this year brings you immense joy, growth, and success, and that you achieve everything you’re working so hard for.
Watching you chase your dreams inspires me every day.
I love you ❤️❤️</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours- Salonee 💖</h2>
          <p className="final-subtitle">Once again, happy birthday, my love. I hope your day is as beautiful and special as your heart. I’ll always be by your side, today and forever.❤️</p>
        </section>
      </div>
